...
const ResultCard = ({ movie }) => {
  ...
  const { addMovieToFavoritelist, addMovieToWatched, favoritelist, watched } =
    useContext(GlobalContext);

  // store movies - check for object
  let storedMovie = favoritelist.find((o) => o.id === movie.id);
  // store movies in watched
  let storedMovieWatched = watched.find((o) => o.id === movie.id);

  // we don't want to store movies - button disabled - movie already stored
  const favoritelistDisabled = storedMovie
    ? true
    : storedMovieWatched
    ? true
    : false

  // button disabled on add to watched 
      ...
      <div className="result__card">
        ...
        <div className="info">
          ...
          <div className="favorite">
            ...
            {/* trigger add movie to watched on btn - send movie object accessed in the props */}
            <button
